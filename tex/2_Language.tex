...
complete calculus for \system{K}{n}{} finds a model for a formula if, and only
...
\system{K}{n}{} we use in this work is based in resolution, which is one of
...
complete for \system{K}{n}{}, it was developed with regard to computer
...
along side with its transformation rules for formulae in \system{K}{n}{}. These
