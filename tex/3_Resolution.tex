...
\begin{example}%
    ...
    The translation leads us with eigth clauses, two of them at the subsequent
    modal level ($1 : \neg t_4 \lor a$ and $1 : \neg t_4 \lor \neg b$). Note
...
\begin{example}%
    ...
    \begin{table}[h!]%
        ...
        \begin{tabular}{rll}
            1. & $0 : t_0$ & \\
            2. & $0 : \neg t_0 \lor t_2 \lor t_1$ & \\ 
            3. & $0 : \neg t_1 \lor t_5 \lor t_3$ & \\
            4. & $0 : t_2 \then \pos {}t_4$       & \\
            5. & $0 : t_5 \then \pos{} \neg a$    & \\
            6. & $0 : t_3 \then \nec{} b$         & \\
            7. & $1 : \neg t_4 \lor a$            & \\
            8. & $1 : \neg t_4 \lor \neg b$       & \\
            %9. & $0 : \neg t_0 \lor t_2 \lor t_5 \lor t_3$ & \\ 
       \end{tabular}%
        \label{tab:calcsat}
    \end{table}
\end{example}
