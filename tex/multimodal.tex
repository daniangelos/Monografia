...
%\begin{tikzpicture}[->,rectangle,draw,node distance=1.5cm,
    ...
    \node[circle,label=180:$\st_0$,draw,thick,minimum width=1.4cm](w0){$
        ...
        \end{array}
    $};
    \node[circle,label=180:$\st_2$,below right of=w0,draw,thick,minimum width=1.4cm](w1) {$
        \begin{array}{c}       
            \neg p\\
        \end{array}
    $};
    \node[circle,label=0:$\st_1$,below left of=w0,draw,thick,minimum width=1.4cm](w2) {$
        \begin{array}{c}       
            \neg p\\
        \end{array}
    $};
